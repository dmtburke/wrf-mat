...
lonwidth = size(u.long, 1);
lonheight = size(u.long, 2);

fmLonTL = u.long(1);
fmLonTR = u.long(lonwidth,1);
fmLonBL = u.long(1,lonheight);
fmLonBR = u.long(lonwidth, lonheight);

latwidth = size(u.lat, 1);
latheight = size(u.lat, 2);

fmLatTL  = u.lat(1);
fmLatTR  = u.lat(latwidth,1);
fmLatBL  = u.lat(1, latheight);
fmLatBR  = u.lat(latwidth, latheight);
